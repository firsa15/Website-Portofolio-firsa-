...
<html lang="en">
    <head>
        ...
        <title>Firsa Anata Mernisi - Computer Science</title>
    ...
    <body>
            ...
            <div class="main-container">
                <div class="nav">
                    ...
                    <nav>
                        <ul>
                            ...
                            <li>
                                <a href="/rsume.pdf" target="_blank">
                ...
                <section id="hero">
                    <div class="hero-left">
                        ...
                        <h1 class="hero-name">Firsa <span>Anata Mernisi</span></h1>
                        <p>
                            Mahasiswa Binus angkatan B-26, Semester 4. Jurusan Computer Science
                        </p>
                    </div>
        ...
        <section id="services">
            <div class="services main-container">
                ...
                <h1 class="section-title services-title">Interested In</h1>
                <div class="grid-3">
              <!--service 1-->
                    <div class="service">
        ...
        <h4>UI/UX</h4>
        <p>
            Focused on UI/UX Design, interested in learning and implementing,
            though not yet an expert.
        </p>
    </div>
                </div>
        </section>
...
<section id="portfolios">
    <div class="portfolios main-container">
        <h3 class="pre-title">My Certificate</h3>
        ...
        <!--portfolio 1-->
            <div class="portfolio">
                <div class="portfolio-cover">
                    <img src="./images/certif/certfi-1.png" alt="Portfolio 1">
                </div>
                <div class="portfolio-info">
                    <div class="portfolio-title">
                        <h4>Porsinara</h4>
                        <a href="/" class="portfolio-link">
                            <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M14 4h-13v18h20v-11h1v12h-22v-20h14v1zm10 5h-1v-6.293l-11.646 11.647-.708-.708 11.647-11.646h-6.293v-1h8v8z"/>
                            </svg>
                        </a>
                    </div>
                    ...
                    <p>
                    I got this certificate when I did a competition held by the campus between departments. The name of this event is porsinara,
                    my team and I won and won second place.
                    </p>
                </div>
            </div>
            <!--portfolio 2-->
            <div class="portfolio">
                <div class="portfolio-cover">
                    <img src="./images/certif/cerftif-2.png" alt="Portfolio 1">
                </div>
                <div class="portfolio-info">
                    <div class="portfolio-title">
                        <h4>Java Script</h4>
                    ...
                    <p>
                    The second certificate, I got because of the java script introduction test, to get it you have to get a high score,
                    and there is a score limit to get a certificate.
                    </p>
                </div>
            </div>
            <!--portfolio 3-->
            <div class="portfolio">
                <div class="portfolio-cover">
                    <img src="./images/certif/certif-3.png" alt="Portfolio 1">
                </div>
                <div class="portfolio-info">
                    <div class="portfolio-title">
                        <h4>Digifest</h4>
                    ...
                    <p>
                    The thrid certificate, I got because I joined the committee of a webinar event with a technology theme, the name of the event was "Digifest".
                    I was part of the event division.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="skills-grid">
            <div class="skills-left">
                ...
                <div class="education-info">
                    <h4 class="education-title">SMP Bayt Al-Hikmah</h4>
                    <p>Junior High School</p>
                    <h4 class="education-years">2016-2019</h4>
                </div>
                </div>
                <!--education 2-->
                <div class="education">
                ...
                <div class="education-info">
                    <h4 class="education-title">SMA Sabilillah</h4>
            ...
            <div class="skills-right">
                <p>
                    For 3 years and a half I have been studying at Bina Nusantara University, I am currently in my 4th semester, majoring in Computer Science.
                    I pursue and study computer systems from software to hardware, and also learn to develop technology
                    in the form of games and others, such as AR / VR.
                </p>
...
<section id="contact">
    <div class="contact main-container">
        <div class="contact-left">
            <form class="contact-form" action="https://formspree.io/f/mbjnqork" method="POST">
                <div>
...
<div class="contact-item">
    ...
    <div class="contact-item">
        <div class="contact-item-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 12.713l-11.985-9.713h23.97l-11.985 9.713zm0 2.574l-12-9.725v15.438h24v-15.438l-12 9.725z"/>
            </svg>
        </div>
        <div class="contact-item-detail">
            <h4>Email</h4>
            <p>firsamernisi@gmail.com</p>
        </div>
    </div>
        </div>
</section>
